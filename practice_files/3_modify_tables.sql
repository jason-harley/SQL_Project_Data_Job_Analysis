...
\copy company_dim FROM 'C:\Users\jason\OneDrive\Documents\SQL_Project_Data_Job_Analysis\csv\company_dim.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy skills_dim FROM 'C:\Users\jason\OneDrive\Documents\SQL_Project_Data_Job_Analysis\csv\skills_dim.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy job_postings_fact FROM 'C:\Users\jason\OneDrive\Documents\SQL_Project_Data_Job_Analysis\csv\job_postings_fact.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy skills_job_dim FROM 'C:\Users\jason\OneDrive\Documents\SQL_Project_Data_Job_Analysis\csv\skills_job_dim.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
